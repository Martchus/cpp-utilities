...
function (configure_development_warnings)
    ...
    if (TREAT_WARNINGS_AS_ERRORS)
        if (DEFINED META_TREAT_WARNINGS_AS_ERRORS AND NOT META_TREAT_WARNINGS_AS_ERRORS)
            message(AUTHOR_WARNING "TREAT_WARNINGS_AS_ERRORS is disabled by project ${META_TARGET_NAME}.")
        elseif (CMAKE_CXX_COMPILER_ID MATCHES ".*Clang" OR CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
            list(APPEND COMPILE_OPTIONS_TO_CONFIGURE -Werror -Wno-error=address -Wno-error=sfinae-incomplete)
        else ()
