...
set(META_APP_BASE_NAME "${META_APP_NAME}")
...
if (WIN32)
    # under Windows all executables and libs are output in the same directory
    set(PRESENT_SRCDIR_REFS "")
    if (EXISTS "${CMAKE_BINARY_DIR}/bin/srcdirref")
        file(STRINGS "${CMAKE_BINARY_DIR}/bin/srcdirref" PRESENT_SRCDIR_REFS)
    endif ()
    if (NOT "${META_SRCDIR_REFS}" IN_LIST PRESENT_SRCDIR_REFS)
        if (PRESENT_SRCDIR_REFS)
            file(APPEND "${CMAKE_BINARY_DIR}/bin/srcdirref" "\n${META_SRCDIR_REFS}")
        else ()
            file(APPEND "${CMAKE_BINARY_DIR}/bin/srcdirref" "${META_SRCDIR_REFS}")
        endif ()
    endif ()
else ()
